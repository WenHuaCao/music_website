 window.onload = function () {
    ...
    //     {
    //         "song_id":"1",
    //         "songList_songname":"光年之外",
    //         "songList_songauthor":"邓紫棋",
    //         "songList_album":"我也不知道",
    //         "songList_songtime":"5:20"
    //     },
    //     {
    //         "song_id":"2",
    //         "songList_songname":"东风破",
    //         "songList_songauthor":"周杰伦",
    //         "songList_album":"叶惠美",
    //         "songList_songtime":"5:13"
    //     },
    //     {
    //         "song_id":"3",
    //         "songList_songname":"倒带",
    //         "songList_songauthor":"周杰伦",
    //         "songList_album":"无与伦比演唱会",
    //         "songList_songtime":"4:36"
    //     },
    //     {
    //         "song_id":"4",
    //         "songList_songname":"告白气球",
    //         "songList_songauthor":"周杰伦",
    //         "songList_album":"周杰伦的床边故事",
    //         "songList_songtime":"3:35"
    //     }
    // ];
    ...
    //         {
    //             "playlist_id":"33",
    //             "list_img":"images/songlist_1.jpg",
    //             "list_name":"依然范特西",
    //             "list_num" : "11"
    //         },
    //         {
    //             "playlist_id":"33",
    //             "list_img":"images/songlist_2.jpg",
    //             "list_name":"七里香",
    //             "list_num" : "11"
    //         }
    //     ];
        ...
        function get_list(this_songid)  //向后台发送get请求，得到歌单数据
        {
            ...
            for (var i = 0; i < is.length; i++) {
               is[i].onclick = add_list;
                    ...
                    //         "list_num" : "11"
                    //     */
                    //     my_songlist[i]['playlist_id'] = data[i]['playlist_id'];
                    //     my_songlist[i]['list_img'] = data[i]['list_img'];
                    //     my_songlist[i]['list_name'] = data[i]['list_name'];
                    //     my_songlist[i]['list_num'] = data[i]['list_num'];
