# Generated by Django 2.1.5 on 2019-06-12 11:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('build_user', models.ForeignKey(default=1, on_delete=True, related_name='build_user', to=settings.AUTH_USER_MODEL)),
                ('collectuser', models.ManyToManyField(related_name='collect_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Song',
        ...
        migrations.AddField(
            model_name='playlist',
            name='songs',
            field=models.ManyToManyField(blank=True, to='sample.Song'),
        ),
    ]
